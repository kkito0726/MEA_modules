...
電極間距離 (μm) [450]:                     ← 450 なら空欄のまま Enter でOK
...
> 💡 **電極間距離はたいてい 450**: 多くの計測は 450μm なので、ここは**何も入力せず Enter**
> （空欄のまま）でOKです。違う間隔のときだけ数字を入れてください。
...
| 電極間距離 | 電極の間隔(μm) | **`450` ならそのまま Enter（空欄でOK）** |
