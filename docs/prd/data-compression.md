...
| 指標 | 値 | 意味 |
|---|---|---|
| 1 LSB（ADC分解能） | `6.10e-03 mV` | これ以下の差は測定器が元々区別できていない |
| float32化の最大誤差 | `7.63e-06 mV` | — |
...
|---|---|---|---|
| highpass(1Hz) | `1.89e-07 mV` | `8.9e-08` | **0.000** |
| bandpass(1-1000) | `4.49e-08 mV` | `8.6e-08` | **0.000** |
| bandpass(100-3000) | `1.15e-07 mV` | `9.6e-08` | **0.000** |
| notch(50Hz) | `2.19e-07 mV` | `8.7e-08` | **0.000** |
